public class WordSearchClient {
   public static void main(String[] args) {
      WordSearchEngine test = new WordSearchEngine();
      
      WordSearchEngine test1 = new WordSearchEngine();
      test1.loadLexicon("OWL.txt");
      System.out.println(test.isOnBoard("ACE"));
      /**
      ...
      System.out.println(test.isOnBoard("churchgoers"));
      System.out.println(test.getBoard());
      System.out.println(test.getAllScorableWords(10)); **/
   }
}